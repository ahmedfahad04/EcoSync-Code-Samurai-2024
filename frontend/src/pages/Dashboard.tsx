                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                {trips?.map((trips) => {
                                    return (
                                        <tr>
                                            <td className="py-2 px-4">{trips.vehicle.vehicle_number}</td>
                                            <td className="py-2 px-4">{trips.sts.sts_name}</td>
                                            <td className="py-2 px-4">{trips.sts_departure_time}</td>
                                            <td className="py-2 px-4">{trips.landfill.landfill_name}</td>
                                            <td className="py-2 px-4">{trips.landfill_dumping_time ?? "Not Dumped yet"}</td>
                                        </tr>
                                    );
                                })}
                            </tbody>
